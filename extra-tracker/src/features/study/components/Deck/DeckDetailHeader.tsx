                ...
                <div className="flex flex-col gap-4 md:gap-6 mb-6">
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex items-start gap-3 md:gap-4">
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                onClick={onBack}
                                className="p-2.5 md:p-3 rounded-xl bg-theme-surface hover:bg-theme-card border border-theme-default text-theme-secondary hover:text-theme-primary transition-all flex-shrink-0 mt-1 touch-manipulation"
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="flex items-center gap-2 md:gap-3 mb-2 flex-wrap">
                                    <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-theme-primary truncate max-w-full">
                                        {deck.title}
                                    </h1>
                                    {hasDueCards && (
                    ...
                    <div className="flex flex-wrap items-center gap-2 md:gap-2.5">
                        ...
                        <motion.button
                            ...
                            disabled={!hasCards}
                            className={`
                                flex items-center gap-2 px-4 md:px-5 py-2.5 rounded-xl font-semibold
                                transition-all shadow-lg touch-manipulation min-h-[44px]
                                ${hasCards 
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4 mb-6">
                    {statItems.map((stat, index) => (
                        <motion.div
                            ...
                            className="p-3 md:p-4 rounded-xl md:rounded-2xl bg-theme-surface border border-theme-default hover:bg-theme-card transition-colors"
                        >
                            <div className="flex items-center gap-2.5 md:gap-3">
                                <div className={`p-2 md:p-2.5 rounded-lg md:rounded-xl ${stat.bgColor}`}>
                                    <stat.icon className={`w-4 h-4 md:w-5 md:h-5 ${stat.color}`} />
                                </div>
                                <div>
                                    <p className="text-xl md:text-2xl font-bold text-theme-primary">{stat.value}</p>
                                    <p className="text-[10px] md:text-xs text-theme-secondary uppercase tracking-wide">{stat.label}</p>
                                </div>
                            </div>
                        </motion.div>
                    ))}
