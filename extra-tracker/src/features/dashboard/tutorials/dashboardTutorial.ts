...
export const dashboardTutorial: TutorialConfig = {
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Queste card mostrano le tue statistiche giornaliere: studio e obiettivi completati.',
            position: 'bottom',
            waitForElement: true,
        },
        {
            ...
            title: 'Azioni Rapide',
            description: 'Accedi velocemente alle funzionalità principali: crea un obiettivo o inizia a studiare.',
            position: 'bottom',
            waitForElement: true,
        },
        {
