...
// Currency / Money
export const CurrencyIcon = ({ className = "", size = 20 }: IconProps) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
// Stop Icon (for end time)
export const StopIcon = ({ className = "", size = 20 }: IconProps) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
// Euro Icon
export const EuroIcon = ({ className = "", size = 20 }: IconProps) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
// Target / Obiettivo (freccietta che centra l'obiettivo)
